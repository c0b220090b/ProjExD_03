...
class Bomb:
    ...
    def __init__(self):
        ...
        引数2 rad：爆弾円の半径
        """
        rad = random.randint(10, 50) #半径の設定
        color = random.choice(__class__.colors) #色の設定
...
class Explosion:
    def __init__(self, bomb : Bomb):
        ...
        """
        self.lst = []
        self.gif = pg.image.load(f"fig/explosion.gif")
        self.lst.append(self.gif)
...
def main():
    ...
    while True:
        ...
        els_lst = [els for els in els_lst if els.life > 0]
